...
/**
 * Parses an OpenAI rate-limit message like "...Please try again in
 * 16.634999999s..." into whole seconds to wait. Returns null if the
 * message doesn't match this shape (e.g. OpenAI changes their error
 * format), so callers can fall back to manual-retry-only behavior instead
